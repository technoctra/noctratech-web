...
<div className="flex gap-16 text-[10px] mono text-white/30 uppercase tracking-[0.4em]">
            {[
              { name: "Github", url: "#" },
              ...
              <Magnetic key={social.name}>
                <motion.a 
                  ...
                  className="hover:text-[#F8FAFC] transition-all relative interactive group"
                >
                  {social.name}
        ...
        <div className="text-[10px] mono text-white/20 text-center md:text-right space-y-4">
          <div className="flex items-center justify-center md:justify-end gap-3 text-[#00F2FF]/60 bg-white/5 px-4 py-2 rounded-full border border-white/5 shadow-xl">
