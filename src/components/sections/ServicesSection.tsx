...
export default function ServicesSection() {
  ...
  return (
    <section id="services" className="min-h-screen py-20 sm:py-32 px-4 sm:px-6 relative flex flex-col items-center overflow-hidden snap-start">
...
<motion.div 
          ...
          >
          <div className="mono text-[#00F2FF] text-[10px] sm:text-xs mb-4 tracking-[0.4em] uppercase">CAPABILITIES // CORE_EXPERTISE</div>
...
<motion.div 
          ...
          {services.map((s, i) => (
              <motion.div
                ...
                className={`premium-card p-8 group interactive relative h-full flex flex-col justify-between overflow-hidden border-white/5 transition-all duration-500 cursor-pointer shadow-xl perspective-1000 ${
                  s.size === "lg" ? "lg:col-span-2 lg:row-span-1" : s.size === "md" ? "lg:col-span-2" : ""
                }`}
              >
